...
<body>
    ...
    <div id="outer">
        ...
        <form action="<%=contextPath%>/notice/edit" method="post">
            ...
            <div id="section">
                제목 <input type="text" size="75" name="title" required value="<%=vo.getTitle()%>">
                <br>
                내용
                <br>
                <textarea rows="10" cols="85" style="resize: none;" name="content" required><%=vo.getContent() %></textarea>
            </div>
            <div id="div-btn-area">
